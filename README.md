...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-we?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-we)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-we.git
cd strategy-we
...
```python
from strategy import weStrategy
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-we/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-we/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-we/discussions)
